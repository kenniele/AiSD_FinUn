...
Также обозначает зависимость, но в этом случае идет ранжирование от худшего до лучшего случая выполнения алгоритма

### Big $\Omega$ notation

Все также обозначает зависимость, но тут это обозначение показывает нижнюю границу, то есть скорость количество
